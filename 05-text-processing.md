...
“어떤 주소·계정에서 인증 실패가 반복됐는가?” [SSH 인증 로그 실습](05-text-processing/05-4-auth-pipeline.md)에서 원문→행 선택→주소→빈도를 단계별로 확인합니다. 아래 텍스트 도구·JSON 절은 형식과 오류를 더 자세히 학습할 때 사용합니다.
