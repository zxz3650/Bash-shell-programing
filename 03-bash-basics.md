...
“받은 표식이 로그에 있는가?” [IOC 검색 실습](03-bash-basics/03-10-ioc-search.md)에서 문자열·정규식·인수·반복·실패를 연결합니다. 01~02장을 마친 뒤 이 실습을 진행하고, 아래 문법 절은 막히는 개념을 찾아보는 참고 경로로 사용합니다. 모든 문법을 먼저 외울 필요는 없습니다.
