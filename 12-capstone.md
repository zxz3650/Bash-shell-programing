# 12. DFIR Triage와 보안 자동화 종합 실습

## 최종 조사 과제

[Linux DFIR Capstone](12-capstone/12-3-dfir-capstone.md)에서 02~11장의 자료를 통합합니다. 기능별 오프라인 수집 함수, manifest·해시·KST, 부분 실패, 사실·가설·누락 보고서를 제출합니다. 아래 기존 로그 보고서·로컬 스냅샷 프로젝트는 구현 기본기 보충과 선택 확장으로 유지합니다.
