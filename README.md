...
[학습 안내와 실습 연결표](course-guide.md)에서 교안·노트북·프로젝트의 연결을 먼저 확인합니다. 12개 장과 33개 상세 절을 학습하며, 각 절은 개념 설명·실행 예제·결과 해석·실패 사례·학생 실습·완료 기준으로 구성합니다. 01장에서는 조사 질문으로 시작해 명령과 Bash 문법을 익히고, 고정 자료 분석과 자기 환경 관찰을 구분합니다.
