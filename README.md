...
[학습 안내와 실습 연결표](course-guide.md)에서 교안·노트북·프로젝트의 연결을 확인합니다. 12개 장과 48개 상세 절 중 각 장의 보안 실습을 먼저 진행하고 필요한 문법 참고 절을 찾아봅니다. 실습은 예상 출력·해석·실패 사례·분석 질문·완료 기준으로 이어집니다.
