# 04. 파일시스템 조사와 안전한 입출력

## 보안 질문에서 시작하기

“최근 파일의 이름·시각·내용·실행 흔적은 무엇을 증명하는가?” [파일시스템 조사 실습](04-file-io/04-4-filesystem-investigation.md)에서 find·stat·해시와 NUL 구분을 연결합니다. 아래 경로·권한·저장 절은 필요한 기본기를 보충합니다.
