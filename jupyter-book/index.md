...
교안은 12개 장·49개 상세 절이며 노트북은 23개다. security-02부터 security-12까지는 장별 보안 실습이고 기존 00부터 11까지는 기초·심화 참고 실습이다. [학습 연결표](../course-guide.md)에 따라 보안 질문·출력 해석·실패 처리·원본 보존을 연결한다.
