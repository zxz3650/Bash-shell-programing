...
| 01 | Bash와 Python 선택 기준 | [노트북 보기](https://github.com/zxz3650/Bash-shell-programing/blob/master/jupyter-book/labs/01-when-to-use-bash.ipynb) | [Colab에서 실행](https://colab.research.google.com/github/zxz3650/Bash-shell-programing/blob/master/jupyter-book/labs/01-when-to-use-bash.ipynb) |
